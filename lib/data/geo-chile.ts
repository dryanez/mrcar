// Chilean Regions and Comunas Database
...
export const chileanRegions: Record<string, Region> = {
    'Arica y Parinacota': {
...
export const getRegions = (): string[] => {
    return Object.keys(chileanRegions).sort()
}

export const getComunas = (region: string): string[] => {
    if (!chileanRegions[region]) return []
    return chileanRegions[region].comunas.sort()
}
